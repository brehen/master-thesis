...
debian_data <- as.tbl_json(read_json("../data/docker-debian-0.2.1.json"))
archlinux_data <- as.tbl_json(read_json("../data/docker-archlinux-0.2.1.json"))
ubuntu_data <- as.tbl_json(read_json("../data/docker-ubuntu-0.2.1.json"))
