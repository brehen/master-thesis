...
In this thesis, we are interested in exploring the potential of \ac{Wasm} and
...
\ac{Wasm}-based functions can offer improved performance and reduced energy
...
- Use this prototype to compare the performance of \ac{Wasm}-based functions to containerized
functions in terms of startup latency and execution time
- Find out if \ac{Wasm}-based functions consume less energy than containerized
...
integration of Wasm and WASI, using the Rust programming language.

- The experimental setup and methodology employed to compare the performance and
energy consumption of \ac{Wasm}-based functions against containerized functions.
