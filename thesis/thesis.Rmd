...
increased impact on the environment. As mentioned in \autoref{chap:intro}, the ICT
industry accounts for an estimated 2.1% to 3.9% of global greenhouse emissions.
The latest figure from 2021 calculates that data centers across the globe
consumes about 200 TWh/year, accounting for 1% of the global electricity
consumption. This estimate is projected to escalate to reach even 15% to 30% of
electricity consumption in some countries by 2030 \citep{freitag2021}.
...
Virtualization and resource pooling, two key components to cloud computing, also
