...
\inputminted[firstline=12, lastline=13]{bash}{assets/code/commands.sh}
...
Now we are ready to deploy Nebula to each server and deploy our functions.
...
\subsection{Setting up our energy measurements}
