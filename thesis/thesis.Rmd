...
sensors for our measurements, its register address, and how accurate its
reported units are. 
...
```{r, avg-efficiency-nrec-rpi, echo=F, warning=F, dev = "cairo_pdf", fig.height=7, fig.align = 'center', fig.cap="Mean startup and runtimes on both our setups."}
...
Based on these factors, our findings are summarized in
\Cref{tab:nrec-avg,tab:rpi-avg}. These tables shows the direct comparison of
each metric we set out to measure between \ac{Wasm} modules and Docker
containers on our setups.
