...
\todo{Maybe start this section differently. Say what we want to achieve, and
then compile the list of statements from that}
...
3. Determine whether WebAssembly is a more energy efficient choice.
...
5. Perform each set of function and input 6 times. This is lets us gather a
