...
invaluable the past semesters. [@tapioniemiGreenBigData2018]
...
a leading contributor to climate change [@mytton2020]. This reality
...
by the WebAssembly community \cite{MattB2022}. Where the two first waves of
...
in August the same year \cite{barrj2006}. With these services, AWS positioned
...
VMs, designed to overcome these hurdles [@bao2016] \cite{@bao2016}. 
...
Gigabytes in image size [@durieux2023], and can take a long time to start up.
...
\midrule
\rowcolor{green!10} Reduced total cost of ownership & Cloud computing enables
companies to reduce upfront infrastructure costs and optimize expenses as they
scale. Important for startups who can't afford to manage their own
infrastructure. \cite{Thomas2009}. \\
Scalability & Offers the ability to efficiently scale operations and resources
in response to changing demand \cite{Thomas2009}. \\
\rowcolor{green!10} Portability & Cloud services provide  \\
\bottomrule
\end{tabular}
...
and robustness \cite{tomaszjon2019}. This rings especially true in the world of
...
\begin{table}[ht]
\centering
\caption{Cloud Computing Challenges}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.3\linewidth} >{\raggedright\arraybackslash}p{0.6\linewidth}}
\toprule
\textbf{Benefit} & \textbf{Description} \\
\midrule
...
organizations. \cite{Rimol2021} \\
Energy consumption & The environmental impact and energy usage of data centers pose significant sustainability challenges. Data centers alone account for approximately 1% of the world's energy consumption. \cite{Freitag2021} \\
\end{tabular}
\label{table:benefits}
\end{table}
