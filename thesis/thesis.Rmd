...
To investigate the problem statements posed in \autoref{sect:problems} a
prototype \ac{FaaS} platform will created and used to perform
experiments and try to either prove or disprove that WebAssembly is a more
energy efficient target for developing cloud native applications.

This chapter will outline the design of the prototype and the tests that will be
performed to measure energy consumption over multiple function invocations. 
